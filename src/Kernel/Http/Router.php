...
namespace coffeforme\Kernel\Http;

// use Coffeforme\Controller\Homepage;
use coffeforme\Controller\Base;
...
class Router
{
    private const CONTROLLER_NAMESPACE = 'coffeforme\Controller\\';
