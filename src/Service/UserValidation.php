...
class UserValidation
{
    ...
    private const MAXMUM_NAME_LENGTH = 20;
    public function isEmailValid(string $email): bool
    {
        return strlen($email) <= self::MAXIMUM_EMAIL_LENGTH &&
    ...
    {
        return strlen($name) >= self::MINIMUM_NAME_LENGTH && strlen($name) <= self::MAXMUM_NAME_LENGTH;
    }
}